...
export const AssetRegistry: Record<string, AssetDefinition> = {
  ...
  room_trinis_room_icon: {
    key: "room_trinis_room_icon",
    kind: "room",
    label: "Trini's Room Icon",
    color: "#5b8f8f",
    accentColor: "#f8efe0",
    image: require("../../../assets/rooms/trinis-room/icon.png")
  },
  room_isis_room_icon: {
    key: "room_isis_room_icon",
    kind: "room",
    label: "Isi's Room Icon",
    color: "#4a72d9",
    accentColor: "#eef2ff",
    image: require("../../../assets/rooms/isis-room/icon.png")
  },
  ...
  character_parakeet_blue: {
    key: "character_parakeet_blue",
    kind: "character",
    label: "Parakeet Blue",
    placeholderText: "🦜",
    color: "#2a8fd4",
    accentColor: "#90d0ff",
    image: require("../../../assets/characters/parakeet-blue.png")
  },
